    ...
    if (!window.TradingView || !window.TradingView.host || window.TradingView.reoloadTvjs) {
        var e, t, o, i, r, n, s, a = {
            ...
            d = {
                ...
                QuotesProvider: function(e) {
                    ...
                    l('<iframe id="' + i + '" src="' + r + '" width="0" height="0" frameborder="0" allowTransparency="true" scrolling="no"></iframe>', e.container), t = document.getElementById(i), o = d.postMessageWrapper(t.contentWindow, i), d.bindEvent(t, "load", (function() {
                        e.symbols.forEach(n)
                    }))
                }
            };
        d.WidgetAbstract.prototype = {
            ...
            addWrapperFrame: function(e, t, o) {
                ...
                o = o || "transparent";
                return '<div id="' + this.id + '-wrapper" style="position: relative;box-sizing: content-box;width: ' + r + ";height: " + i + ';margin: 0 auto !important;padding: 0 !important;font-family:Arial,sans-serif;"><div style="width: ' + r + ";height: " + i + ";background: " + o + ';padding: 0 !important;">' + e + "</div>" + (t || "") + "</div>"
            },
            addFooterLogo: function(e, t) {
                var o = (t || {}).greyText || "powered by",
                    i = (t || {}).linkText || "tradingview.com",
                    r = (t || {}).href || "https://www.tradingview.com/";
                return d.WidgetAbstract.prototype.addWrapperFrame.call(this, e, '<div style="position:absolute;display: block;box-sizing: content-box;height: 24px;width: ' + d.WidgetAbstract.prototype.width.call(this) + ';bottom: 0;left: 0;margin: 0;padding: 0;font-family: Arial,sans-serif;"><div style="display: block;margin: 0 1px 1px 1px;line-height: 7px;box-sizing: content-box;height: 11px;padding: 6px 10px;text-align: right;background: #fff;"><a href="' + r + "?" + d.generateUtmForUrlParams(this.options) + '" target="_blank" style="color: #0099d4;text-decoration: none;font-size: 11px;"><span style="color: #b4b4b4;font-size: 11px;">' + o + "</span> " + i + "</a></div></div>", "#fff")
            }
            ...
            widgetCode: function() {
                ...
                return '<iframe src="' + (d.chatHost + "/chatwidgetembed/?" + o + t + e) + '"' + (this.options.width ? ' width="' + this.options.width + '"' : "") + (this.options.height ? ' height="' + this.options.height + '"' : "") + ' frameborder="0" allowTransparency="true" scrolling="no"></iframe>'
            }
            ...
            createWidget: function() {
                ...
                this.postMessage = d.postMessageWrapper(o.contentWindow, this.id), this.postMessage.on("resize", (function(e) {
            ...
            createWidget: function() {
                ...
                var t = this,
                    o = document.getElementById(this.id);
                this.postMessage = d.postMessageWrapper(o.contentWindow, this.id), d.bindEvent(o, "load", (function() {
                    t._ready = !0;
            ...
            widgetCode: function() {
                ...
                for (var s = ["gridLineColor", "fontColor", "underLineColor", "underLineBottomColor", "trendLineColor", "activeTickerBackgroundColor", "timeAxisBackgroundColor", "locale", "scalePosition", "scaleMode", "chartType", "lineColor", "topColor", "bottomColor", "upColor", "downColor", "borderUpColor", "borderDownColor", "wickUpColor", "wickDownColor", "fontFamily", "noTimeScale", "valuesTracking"], a = "", l = s.length - 1; l >= 0; l--) {
                    var h = s[l],
                        c = this.options[h];
                ...
                var b = d.getHost(this.options) + w + "?" + t + e + a + p + g + o + i + r + m + n + u + y;
                return '<iframe id="' + this.id + '" src="' + b + '" style="margin: 0 !important; padding: 0 !important; ' + (this.options.width ? "width: " + this.options.width + "; " : "") + (this.options.height ? "height: " + this.options.height + ";" : "") + '" frameborder="0" allowTransparency="true" scrolling="no"></iframe>'
            },
            remove: function() {
                var e = document.getElementById("tradingview_widget");
                e.parentNode.removeChild(e)
            ...
            create: function() {
                ...
                o && o.parentElement && o.parentElement.removeChild(o), this.iframe = document.getElementById(this.id), this.postMessage = d.postMessageWrapper(this.iframe.contentWindow, this.id), d.bindEvent(this.iframe, "load", (function() {
        ...
        }, d.postMessageWrapper = (o = {}, i = {}, r = {}, n = 0, s = 0, window.addEventListener && window.addEventListener("message", (function(e) {
            var r;
            try {
                r = JSON.parse(e.data)
            } catch (e) {
