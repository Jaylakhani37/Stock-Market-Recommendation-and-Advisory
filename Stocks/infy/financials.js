(() => {
    ...
    (() => {
        ...
        function r(t) {
            ...
            return "http:" === i.protocol && (e = e.replace(/:80$/, "")), "https:" === i.protocol && (e = e.replace(/:443$/, "")), r = ("/" === i.pathname[0] ? "" : "/") + i.pathname, {
                host: e,
                pathname: r,
                href: i.href
            }
        ...
        new class extends class {
            ...
            _getScriptsInfo() {
                ...
                const {
                    host: i,
                    href: n
                } = r(e), s = document.getElementsByTagName("script"), o = [];
            ...
            _replaceScript(t) {
                ...
                this.hasCopyright = a || l, s && (this.settings = this.filterRawSettings(s)), s && this._isValidSettings() || (console.error("Invalid settings provided, fall back to defaults"), this.settings = this.filterRawSettings(this.defaultSettings));
                ...
                this.script.parentNode && d ? this.iframeContainer = this.script.parentNode : this.iframeContainer = document.createElement("div"), this.iframeContainer.style.width = h, this.iframeContainer.style.height = c, this.iframeContainer.appendChild(function() {
                ...
                this.settings.utm_source = location.hostname, this.settings.utm_medium = l ? "widget_new" : "widget", this.settings.utm_campaign = this.widgetUtmName, this.iframe = this._createIframe(p, h, r, i, n.id);
                const m = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
                if (m ? (this.script.parentNode.replaceChild(this.iframe, m), this.script.parentNode.removeChild(this.script)) : d ? (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.removeChild(this.script)) : (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.replaceChild(this.iframeContainer, this.script)), function(t, e, i) {
                    ...
                    t.style.height = "32px", t.style.lineHeight = "32px", t.style.width = h, t.style.textAlign = "center", t.style.verticalAlign = "middle", t.innerHTML = a.innerHTML, this.iframeContainer.appendChild(t)
                }
            }
            _iframeSrcBase(t, e) {
                let i = this.useWidgetHostForProduction ? "https://www.tradingview-widget.com" : "https://s.tradingview.com";
                return this.settings.useWidgetHost ? i = "https://www.tradingview-widget.com" : "local" === e ? i = "http://" + t : "staging" === e && (i = -1 !== t.indexOf("beta.tradingview.com") ? "https://betacdn.tradingview.com" : "https://" + t), i += `/embed-widget/${this.widgetId}/`, this.settings.customer && -1 !== this.propertiesToSkipInHash.indexOf("customer") && (i += this.settings.customer + "/"), i
            }
            _isValidSettings() {
                const t = function(t) {
            ...
            get propertiesToWorkWith() {
                return ["width", "height", "autosize", "symbol", "locale", "colorTheme", "isTransparent", "colorTheme", "displayMode", "largeChartUrl", "customer", "useWidgetHost"]
            }
        }
    })()
})();